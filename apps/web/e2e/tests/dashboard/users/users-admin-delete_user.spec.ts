...
test.describe("User admin delete account", () => {

    test("USR-022-a: create new user account with valid credentials", async ({page, }) => {
    ...
    test("USR-022-b: login with created user and delete user", async ({page, }) => {
